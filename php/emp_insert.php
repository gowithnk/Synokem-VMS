...
<form action="emp_insert_1.php" method="post">
	...
	<div class="emp_main">	
		...
		<div class="admin_center">
			...
			<div style="width: 76%;">   
					<label style="font-size: 18px; color: white; margin-left:50px;">Gender : </label>			
			...
			<input type="text" name="code" placeholder="Employee Code" required style="width: 70%; height:1px; border-radius: 10px;border:none; margin-left: 22px; padding: 16px;margin-top: 10px; background-color: antiquewhite;"><br><br>
