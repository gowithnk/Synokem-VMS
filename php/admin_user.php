...
<form action="admin_user_insert_0.php" method="post" enctype="multipart/form-data">
	<div class="admin_transparent">
		<div class="admin_main">
			<span style="color: white; font-size: 32px;font-family: sans-serif;">Admin Account</span>
			<div class="admin_center">
				...
				<input type="text" name="name" onkeypress="return onlyAlphabets(event);" placeholder="Enter your Name" required style="width: 70%; height:1px; border-radius: 10px;border:none; margin-left: 22px; padding: 16px;margin-top: 10px; background-color: antiquewhite;"><br><br>
				<div style="width: 80%;">   
					<label style="font-size: 20px; color: white;">Gender : </label>			
					<input type="radio" name="gender" value="Male" style="margin-left: 18px;">
					<label style="font-size: 18px; color: white;">Male</label>   
					<input type="radio" name="gender" value="Female">
					<label style="font-size: 18px; color: white;">Female</label><br></div>
